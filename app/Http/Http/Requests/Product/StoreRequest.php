...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'picture'=>'required|image|mimes:jpeg,png,jpg,gif,svg|max:2048|dimensions:max_width=100,max_height=200',
            'sell_price'=>'required',
    ...
    public function messages()
    {
        return[
            ...
            'picture.dimensions'=>'Las dimensiones máximas de la imagen son 100px de ancho por 200px de alto.',
